...
export function findLinkedMessage<T extends LinkableMessage>(
	...
	if (typeof message.data !== "object" || message.data?.id === undefined)
		return null;
	...
	if (message.type === "sent" && linkedMsg.type === "received")
		return linkedMsg as T;
	if (message.type === "received" && linkedMsg.type === "sent")
		return linkedMsg as T;
